document.addEventListener('DOMContentLoaded', () => {
    ...
    async function sendImageRequest(prompt) {
        ...
        // Yanzu muna karɓar URL kai tsaye
    ...
    function appendMessage(sender, content) {
        ...
        let avatarSrc = (sender === 'user') ? 
            'https://i.ibb.co/3k5fFFd/user-avatar.png' : 
            'https://i.ibb.co/3sS0kjr/ai-bot-icon.png';
    ...
    newChatBtn.addEventListener('click', () => {
        chatMessages.innerHTML = `
            <div class="message welcome-message">
                <img src="https://i.ibb.co/3sS0kjr/ai-bot-icon.png" alt="AI" class="avatar">
                <div class="text">
